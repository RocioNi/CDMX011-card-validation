...
const validator = {
    ...
    isValid: function(str){
      ...
      for (var i = 0, len = str_reverse.length; i < len; i += 1) { //sacamos la longitud del string y damos la orden del bucle

        if ((i%2) == 0){ //si el residuo  de 2 de la posicion es 0 lo tomara como impar , considerando que el indice del primer elemento es 0
    ...
    for (i = 0, numimp = 0; i < impares.length; i++) { //sacara la longitud de los impares
     ...
     for(i=0; i<pares.length;i++){
       if(pares[i]>9){ // verifica si tiene 2 digitos
         numpar=pares[i];
    ...
    maskify:function (str){  //para ocultar los digitos menos los ultimos 4
